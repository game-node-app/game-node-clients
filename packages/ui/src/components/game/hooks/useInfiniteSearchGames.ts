...
import { parseSearchGamesDto } from "./useSearchGames";

type InfiniteSearchGamesRequest = Omit<games_GameSearchRequestDto, "page">;

export function useInfiniteSearchGames(
  searchParameters: InfiniteSearchGamesRequest,
