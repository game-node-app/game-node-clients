...
import { GameInfoSharePreview } from "#@/components";
...
/**
 * Component that renders an overview of a game's info related to current logged in user. <br />
 * Includes review score, achievements and playtime (if available).
 * @param gameId
 * @param onShare
 * @constructor
 */
