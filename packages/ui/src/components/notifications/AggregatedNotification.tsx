...
import { PostAggregatedNotification } from "#@/components/notifications/item/PostAggregatedNotification.tsx";
import { PostCommentAggregatedNotification } from "#@/components/notifications/item/PostCommentAggregatedNotification.tsx";
  ...
  const notificationContent = useMemo(() => {
    switch (aggregatedNotification.sourceType) {
      ...
      case sourceType.POST:
        return (
          <PostAggregatedNotification
            aggregatedNotification={aggregatedNotification}
          />
        );
      case sourceType.POST_COMMENT:
        return (
          <PostCommentAggregatedNotification
            aggregatedNotification={aggregatedNotification}
          />
        );
