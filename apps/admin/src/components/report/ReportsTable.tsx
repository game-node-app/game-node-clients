...
import { type Report } from "@repo/wrapper/server";
...
const columns: MRT_ColumnDef<Report>[] = [
  ...
  },
  {
    ...
    Cell: (props) => {
      return (
        <UserAvatarGroup userId={props.row.original.targetProfileUserId} />
      );
    },
  },
  {
    ...
    Cell: (props) => {
      return <UserAvatarGroup userId={props.row.original.profileUserId} />;
    },
  },
  {
    header: "Created At",
