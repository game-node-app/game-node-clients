...
const GameInfoSharePreview = ({ gameId, watchFormValues }: SharePreviewProps) => {
    ...
    const { transparentBackground, withRating, withOwnedPlatforms, withDivider } = watchFormValues();
    return (
        <Paper
            ...
            styles={{
                root: {
                    backgroundColor: transparentBackground ? "rgba(255,255,255,0)" : "#1A1A1A",
                },
            }}
        >
