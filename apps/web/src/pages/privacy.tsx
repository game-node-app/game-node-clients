      ...
      <Flex justify={"center"}>
        ...
        >
          <Stack w={"100%"}>
            ...
            <Text>
              Your privacy is important to us. It is GameNode's policy to
              respect your privacy regarding any information we may collect from
              you across our website, GameNode, and other sites we own and
              ...
              may link to external sites that are not operated by us. Please be
              ...
              request for your personal information, with the understanding that
              we may be unable to provide you with some of your desired
              services. Your continued use of our website will be regarded as
            ...
            <Text>
              This is the Cookie Policy for GameNode, accessible from URL
              https://gamenode.app.
            </Text>
            ...
            <Text>
              ...
              <a href={"https://cloudflare.com"}>Cloudflare</a>. As such, this
              third party provider may inject some third party cookies to
              analyze your visits in our site. To avoid this, either disable
              cookies in your browser, or use some form of tracking protection.
            </Text>
            <Text>
            ...
            <Text>
              ...
              for product and web analytics. This means Posthog's Javascript is
              injected in this website and used to collected information about
              your visited pages, usage patterns and etc. We never sell this
              data. It's used exclusively for improving our service.
            </Text>
            <Text>
              You may read Posthog's privacy notice{" "}
              <a href={"https://posthog.com/privacy"}>here</a>.
            </Text>
            <Text>
              Previously, we used Matomo as our analytics tool of choice. We
              discontinued this service because of the maintenance cost of
              keeping our own instance.
            </Text>
            <Title>Consent</Title>
            <Text>
              Please keep in mind that by using our website and services you
              hereby agree to our privacy policy and terms of service.
            </Text>
            <Text>
              If you with to stop using our services and to have your data
              removed from our end (e.g. data we actually have access and
              control of), please feel free to contact us.
            </Text>
          </Stack>
        </Paper>
      </Flex>
